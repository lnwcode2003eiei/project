        ...
        <div className="max-w-3xl">
          ...
          <div>
            ...
            <p className="max-w-xl text-lg leading-9 text-white/85 md:text-xl md:leading-10">
              คณะเทคโนโลยีอุตสาหกรรมมุ่งพัฒนาบัณฑิตนักปฏิบัติ
              โดยผสานความรู้ด้านวิศวกรรมและเทคโนโลยีเข้ากับการลงมือทำ
              ส่งเสริมทักษะการคิดวิเคราะห์ การแก้ปัญหา และการสร้างสรรค์นวัตกรรม
              เพื่อเตรียมความพร้อมสู่วิชาชีพและการเป็นผู้ประกอบการ
              พร้อมนำความรู้ไปพัฒนาท้องถิ่นและภาคอุตสาหกรรม
            </p>
