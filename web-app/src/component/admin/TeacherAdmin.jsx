...
export default function TeacherAdmin() {
  ...
  const chooseImage = (event) => {
    ...
    if (!file.type.match(/^image\/(jpeg|png|webp)$/) || file.size > 10 * 1024 * 1024) {
      setMessage("กรุณาเลือกรูป JPG, PNG หรือ WebP ขนาดไม่เกิน 10 MB");
      event.target.value = "";
      return;
    }
    setImageFile(file);
