...
function HeaderSection({ course }) {
  return (
    <section style={courseHeroStyle("management")} className="course-generated-hero relative overflow-hidden bg-gradient-to-br from-[#701D10] via-[#701D10] to-[#093341] px-6 py-20 text-white shadow-lg">
