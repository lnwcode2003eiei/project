  ...
  useEffect(() => {
    const loadCourse = async () => {
      try {
        ...
        console.error(
          "โหลดข้อมูล Electrical ไม่สำเร็จ:",
          err
        );
...
function HeaderSection({ course }) {
  return (
    <section style={courseHeroStyle("electrical")} className="course-generated-hero relative overflow-hidden bg-gradient-to-br from-[#701D10] via-[#701D10] to-[#093341] px-6 py-20 text-white shadow-lg">
      ...
      <div className="grid items-center gap-12 lg:grid-cols-12">
        ...
        <div className="space-y-6 lg:col-span-6">
          ...
          <h2 className="text-3xl font-bold leading-tight text-gray-900 md:text-4xl">
            {course.about_title || "เรียนอะไรในเทคโนโลยีไฟฟ้า?"}
          </h2>
...
function StudyPlanSection({ course, totalCredits }) {
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-gray-600">
            ...
            {course.title} (รวม {totalCredits} หน่วยกิต)
          </p>
        </div>
          ...
          <table className="w-full border-collapse text-left">
            ...
            <tbody>
              ...
              course.curriculum.length > 0 ? (
                course.curriculum.map((group, groupIndex) => (
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <div className="space-y-4 lg:col-span-5">
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              พัฒนาทักษะเชิงปฏิบัติการด้านระบบไฟฟ้า วงจร และระบบอัตโนมัติ
              เพื่อพร้อมทำงานจริงในอุตสาหกรรม
            </p>
          </div>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-red-100/80">
            แนวทางสายงานและโอกาสการทำงานในสายอาชีพเทคโนโลยีไฟฟ้าและระบบอัตโนมัติ
          </p>
        </div>
  ...
  return (
    <section className="bg-white px-6 py-20 text-center">
      <div className="mx-auto max-w-3xl space-y-6">
        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
          สร้างอนาคตด้วยเทคโนโลยีไฟฟ้า
        </h2>

        <p className="text-lg leading-relaxed text-gray-600">
          พัฒนาความรู้และทักษะด้านไฟฟ้าเพื่อก้าวสู่เส้นทางสายอาชีพ{" "}
          {course?.title || "มืออาชีพในอุตสาหกรรม"}
        </p>

        <div>
          <a href="/apply?major=elec-tech" className="inline-block rounded-xl bg-[#701D10] px-8 py-4 font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-[#093341] hover:shadow-xl">
            สนใจเข้าศึกษา
          </a>
        </div>
      </div>
