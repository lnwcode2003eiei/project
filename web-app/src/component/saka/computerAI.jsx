    ...
    const loadCourse = async () => {
      try {
        ...
        const response = await fetch(
          apiUrl("/api/courses/computer-ai")
        );
        ...
        console.error(
          "โหลดข้อมูล Computer AI ไม่สำเร็จ:",
          err
        );
...
function HeaderSection({ course }) {
  return (
    <section style={courseHeroStyle("computer-ai")} className="course-generated-hero relative overflow-hidden bg-gradient-to-br from-[#7A0019] via-[#8B001E] to-[#580012] px-6 py-20 text-white shadow-lg">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-6 max-w-3xl text-lg font-light leading-relaxed text-red-50/90 md:text-xl">
          {course.hero_description ||
            "เรียนรู้เทคโนโลยีคอมพิวเตอร์ และปัญญาประดิษฐ์ เพื่อพัฒนาระบบอัจฉริยะ และสร้างนวัตกรรมสำหรับโลกยุคดิจิทัล"}
        </p>
      </div>
    </section>
  );
...
// ==========================================
// About (ปรับกรอบรูปให้ใหญ่ขึ้นที่นี่)
// ==========================================
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      <div className="grid items-center gap-12 lg:grid-cols-12">
        {/* Image - ขยายพื้นที่ฝั่งรูปภาพเป็น col-span-6 หรือ 7 */}
...
// ==========================================
// Highlights (นำกรอบสีชมพูออก แสดงเฉพาะรูปภาพ)
// ==========================================
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          course.highlights.length > 0 ? (
            course.highlights.map((item, index) => (
              ...
              >
                {/* เอาพื้นหลังกรอบสีชมพูออก เหลือแค่รูปภาพขนาดใหญ่เต็มตา */}
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <div className="space-y-4 lg:col-span-5">
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              ...
              ปัญญาประดิษฐ์ และการวิเคราะห์ข้อมูล
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-red-100/80">
            แนวทางสายงานและโอกาสการทำงานในยุค AI
          </p>
        </div>
  ...
  return (
    <section className="bg-white px-6 py-20 text-center">
      <div className="mx-auto max-w-3xl space-y-6">
        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
          พร้อมสร้างอนาคตด้วย AI แล้วหรือยัง?
        </h2>
        ...
        <p className="text-lg leading-relaxed text-gray-600">
          ...
          {course?.title ||
            "คอมพิวเตอร์และปัญญาประดิษฐ์"}{" "}
          เพื่อก้าวเข้าสู่อุตสาหกรรมเทคโนโลยีแห่งอนาคต
        </p>

        <div>
          <a href="/apply?major=comp-ai-master" className="inline-block rounded-xl bg-[#7A0019] px-8 py-4 font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-[#580012] hover:shadow-xl">
            สนใจเข้าศึกษา
          </a>
        </div>
      </div>
