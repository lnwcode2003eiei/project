...
function HeaderSection({ course }) {
  return (
    <section style={courseHeroStyle("digital")} className="course-generated-hero relative overflow-hidden bg-gradient-to-br from-[#7A0019] via-[#8B001E] to-[#580012] px-6 py-20 text-white shadow-lg">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12">
          ...
          <div className="space-y-4 lg:col-span-5">
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              พัฒนาทักษะการใช้ซอฟต์แวร์และการออกแบบเชิงดิจิทัล
              เพื่อเตรียมพร้อมสู่ตลาดงานสายครีเอทีฟและเทคโนโลยี
            </p>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-red-100/80">
            แนวทางสายงานและโอกาสการทำงานในสายอาชีพด้านดิจิทัลและดีไซน์
          </p>
  ...
  return (
    <section className="bg-white px-6 py-20 text-center">
      ...
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
          สร้างอนาคตด้วยเทคโนโลยีดิจิทัลเพื่อการออกแบบ
        </h2>

        <p className="text-lg leading-relaxed text-gray-600">
          พัฒนาความคิดสร้างสรรค์และทักษะดิจิทัลเพื่อก้าวสู่เส้นทางสายอาชีพ{" "}
          {course?.title ||
            "นักออกแบบมืออาชีพ"}
        </p>
        ...
        <div>
          ...
          <a href="/apply?major=digital-design" className="inline-block rounded-xl bg-[#7A0019] px-8 py-4 font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-[#580012] hover:shadow-xl">
            สนใจเข้าศึกษา
          </a>
