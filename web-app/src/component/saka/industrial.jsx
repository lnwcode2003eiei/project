  ...
  useEffect(() => {
    const loadCourse = async () => {
      try {
        ...
        console.error(
          "โหลดข้อมูล Industrial ไม่สำเร็จ:",
          err
        );
...
function HeaderSection({ course }) {
  return (
    <section style={courseHeroStyle("industrial")} className="course-generated-hero relative overflow-hidden bg-gradient-to-br from-[#701D10] via-[#701D10] to-[#093341] px-6 py-20 text-white shadow-lg">
      <div className="mx-auto max-w-7xl">
        ...
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight md:text-6xl lg:text-7xl">
          {course.title || "เทคโนโลยีอุตสาหการ"}
        </h1>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12">
          ...
          <div className="space-y-4 lg:col-span-5">
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              พัฒนาทักษะและความรู้ด้านกระบวนการผลิต
              และการจัดการอุตสาหกรรมยุคใหม่
            </p>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-red-100/80">
            แนวทางสายงานและโอกาสการทำงานในสายอาชีพด้านเทคโนโลยีอุตสาหการ
          </p>
  ...
  return (
    <section className="bg-white px-6 py-20 text-center">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
          ขับเคลื่อนภาคการผลิตด้วยเทคโนโลยีอุตสาหการ
        </h2>

        <p className="text-lg leading-relaxed text-gray-600">
          พัฒนาทักษะและความเชี่ยวชาญเพื่อก้าวสู่สายงานอุตสาหกรรมอย่างมืออาชีพ
          {course?.title ? ` ในสาขา ${course.title}` : ""}
        </p>

        <div>
          <a href="/apply?major=ind-tech" className="inline-block rounded-xl bg-[#701D10] px-8 py-4 font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-[#093341] hover:shadow-xl">
            สนใจเข้าศึกษา
          </a>
        </div>
