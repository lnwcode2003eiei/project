...
function HeaderSection({ course }) {
  return (
    <section style={courseHeroStyle("construction")} className="course-generated-hero relative overflow-hidden bg-gradient-to-br from-[#7A0019] via-[#8B001E] to-[#580012] px-6 py-20 text-white shadow-lg">
