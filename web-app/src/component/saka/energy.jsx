...
function HeaderSection({ course }) {
  return (
    <section style={courseHeroStyle("energy")} className="course-generated-hero relative overflow-hidden bg-gradient-to-br from-[#7A0019] via-[#8B001E] to-[#580012] px-6 py-20 text-white shadow-lg">
      ...
      <div className="grid items-center gap-12 lg:grid-cols-12">
        ...
        <div className="space-y-6 lg:col-span-6">
          ...
          <h2 className="text-3xl font-bold leading-tight text-gray-900 md:text-4xl">
            {course.about_title || "เรียนอะไรในสาขานี้?"}
          </h2>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <div className="space-y-4 lg:col-span-5">
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              พัฒนาความรู้ด้านพลังงาน วิศวกรรม และการจัดการ
              เพื่อรองรับอุตสาหกรรมยุคใหม่
            </p>
          </div>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-red-100/80">
            แนวทางสายงานและโอกาสการทำงานในสายอาชีพด้านวิศวกรรมการจัดการพลังงาน
          </p>
        </div>
  ...
  return (
    <section className="bg-white px-6 py-20 text-center">
      <div className="mx-auto max-w-3xl space-y-6">
        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
          พลังงานคืออนาคตของอุตสาหกรรม
        </h2>

        <p className="text-lg leading-relaxed text-gray-600">
          เรียนรู้{" "}
          {course?.title || "การจัดการพลังงาน"}{" "}
          เพื่อสร้างอุตสาหกรรมที่มีประสิทธิภาพและยั่งยืน
        </p>

        <div>
          <a href="/apply?major=energy-mgt-eng" className="inline-block rounded-xl bg-[#7A0019] px-8 py-4 font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-[#580012] hover:shadow-xl">
            สนใจเข้าศึกษา
          </a>
        </div>
      </div>
