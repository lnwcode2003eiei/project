...
function HeaderSection({ course }) {
  return (
    <section style={courseHeroStyle("energy")} className="course-generated-hero relative overflow-hidden bg-gradient-to-br from-[#701D10] via-[#701D10] to-[#093341] px-6 py-20 text-white shadow-lg">
  ...
  return (
    <section className="bg-white px-6 py-20 text-center">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div>
          <a href="/apply?major=energy-mgt-eng" className="inline-block rounded-xl bg-[#701D10] px-8 py-4 font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-[#093341] hover:shadow-xl">
            สนใจเข้าศึกษา
          </a>
        </div>
      </div>
