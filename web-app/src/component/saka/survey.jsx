      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12">
          ...
          <div className="space-y-4 lg:col-span-5">
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              พัฒนาทักษะด้านการสำรวจ ทำแผนที่
              และวิเคราะห์ข้อมูลเชิงพื้นที่ด้วยเทคโนโลยีทันสมัย
            </p>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-red-100/80">
            แนวทางสายงานและโอกาสการทำงานในสายอาชีพด้านเทคโนโลยีสำรวจและภูมิสารสนเทศ
          </p>
  ...
  return (
    <section className="bg-white px-6 py-20 text-center">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
          ขับเคลื่อนข้อมูลเชิงพื้นที่ด้วยเทคโนโลยีสำรวจและภูมิสารสนเทศ
        </h2>

        <p className="text-lg leading-relaxed text-gray-600">
          พัฒนาทักษะและความเชี่ยวชาญเพื่อก้าวสู่สายงานภูมิสารสนเทศอย่างมืออาชีพ
          {course?.title
            ? ` ในสาขา ${course.title}`
            : ""}
        </p>
