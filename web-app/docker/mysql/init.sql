...
-- =========================================================
-- FACULTY CONTENT
-- ข้อมูลสำหรับหน้าแนะนำคณะทั้งหมด
-- =========================================================

INSERT IGNORE INTO faculty_pages (slug, title, content) VALUES
...
('executive', 'ผู้บริหาร', 'ข้อมูลผู้บริหารของคณะ'),
('teacher', 'คณาจารย์ / นักวิจัย', 'ข้อมูลคณาจารย์และนักวิจัยของคณะ'),
('department', 'หน่วยงาน', 'ข้อมูลหน่วยงานและส่วนงานของคณะ');
...
INSERT IGNORE INTO faculty_history (id, hero_title, hero_subtitle) VALUES
(1, 'ประวัติและความเป็นมา', 'ต้นกำเนิดและก้าวสำคัญในการขยายรากฐานทางการเรียนรู้ วิชาชีพทางวิศวกรรมและเทคโนโลยี');

INSERT IGNORE INTO faculty_history_events (id, date_label, title, description, side, icon, display_order) VALUES
(1, 'จุดเริ่มต้นความสำเร็จ', 'จุดเริ่มต้นความสำเร็จ', 'คณะมุ่งเน้นการผลิตบัณฑิตที่มีความรู้ ความสามารถ และทักษะวิชาชีพ เพื่อตอบสนองความต้องการของภาคอุตสาหกรรมและสังคม', 'left', 'lucide:building-2', 0),
(2, 'ปีการศึกษา 2542', 'มุ่งพัฒนาขยายโอกาสทางการศึกษา', 'เริ่มเปิดโอกาสทางการศึกษาเพื่อสร้างบุคลากรที่มีความรู้และทักษะด้านเทคโนโลยี', 'right', 'lucide:hourglass', 1),
(3, 'วันที่ 10 กันยายน 2544', 'จุดเปลี่ยนครั้งยิ่ง: ตั้งเป็นคณะ', 'พัฒนาการครั้งสำคัญเพื่อขับเคลื่อนการศึกษาและเทคโนโลยีอุตสาหกรรม', 'left', 'lucide:award', 2);
...
CREATE TABLE IF NOT EXISTS faculty_structure_image (
    id TINYINT PRIMARY KEY,
    image_filename VARCHAR(255) NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT IGNORE INTO faculty_structure_image (id, image_filename) VALUES (1, NULL);

CREATE TABLE IF NOT EXISTS faculty_structure_images (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS faculty_structure_nodes (
    id INT AUTO_INCREMENT PRIMARY KEY,
    parent_id INT NULL,
    title VARCHAR(255) NOT NULL,
...
INSERT IGNORE INTO faculty_structure_nodes (id, parent_id, title, subtitle, section, theme, display_order) VALUES
...
CREATE TABLE IF NOT EXISTS faculty_vision (
    id TINYINT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS faculty_vision_cards (
    id INT AUTO_INCREMENT PRIMARY KEY,
    title VARCHAR(255) NOT NULL,
    description TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS faculty_vision_image (
    id TINYINT PRIMARY KEY,
    image_filename VARCHAR(255) NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT IGNORE INTO faculty_vision (id, philosophy_title, philosophy_text, ambition_title, ambition_text, goal_title, goal_subtitle) VALUES
(1, 'ปรัชญา', 'มุ่งสร้างบัณฑิตด้านเทคโนโลยีที่มีความรู้ ความสามารถ คุณธรรม และทักษะวิชาชีพเพื่อพัฒนาสังคม', 'ปณิธาน', 'สร้างนวัตกรรมและผลิตบัณฑิตที่มีคุณภาพ เพื่อตอบสนองความต้องการของท้องถิ่นและประเทศ', 'เป้าหมายและการพัฒนาอย่างต่อเนื่อง', 'พัฒนาคณะให้ก้าวทันเทคโนโลยีและความต้องการของสังคม');

INSERT IGNORE INTO faculty_vision_cards (id, title, description, icon, display_order) VALUES
(1, 'วิสัยทัศน์', 'คณะเทคโนโลยีอุตสาหกรรมเป็นองค์กรแห่งการเรียนรู้ ผลิตบัณฑิตที่มีคุณภาพและเป็นที่ยอมรับ', 'lucide:eye', 0),
(2, 'กลยุทธ์', 'พัฒนาหลักสูตร บุคลากร งานวิจัย และเครือข่ายความร่วมมือให้สอดคล้องกับการเปลี่ยนแปลง', 'lucide:route', 1),
(3, 'อัตลักษณ์', 'นักเทคโนโลยี มีทักษะวิชาชีพ มีจิตบริการ และพร้อมทำงานร่วมกับผู้อื่น', 'lucide:user-check', 2),
(4, 'ผลการบริหาร', 'ดำเนินงานอย่างมีประสิทธิภาพ โปร่งใส และมุ่งผลสัมฤทธิ์ของผู้เรียน', 'lucide:users', 3);

INSERT IGNORE INTO faculty_vision_image (id, image_filename) VALUES (1, NULL);
